...
import { ReporterAgent, createReporterAgent, ReportOptions } from './reporter-agent';
import { ScanJob, Vulnerability, SeverityLevel } from '../models/types';
    ...
    vulnerabilities: [
      {
        ...
        description:
          'The login form is vulnerable to SQL injection attacks via the username parameter. An attacker can bypass authentication and gain unauthorized access to the database.',
        type: 'injection',
        severity: 'critical',
        cvss: 9.8,
        cveId: undefined,
        ...
        remediationAdvice:
          'Use parameterized queries or prepared statements for all database operations. Never concatenate user input directly into SQL queries. Implement input validation and use an ORM framework.',
        toolSource: 'SQLMap',
        isZeroDay: false,
      },
      {
        ...
        description:
          'The application allows weak passwords with no complexity requirements. Users can set passwords as short as 4 characters with no special character requirements.',
        type: 'weak-auth',
        severity: 'high',
        cvss: 7.5,
        ...
        remediationAdvice:
          'Implement strong password policy requiring: minimum 12 characters, uppercase and lowercase letters, numbers, and special characters. Implement account lockout after 5 failed attempts. Consider implementing MFA.',
      ...
      },
      {
        ...
        description:
          'Several API endpoints are publicly accessible without authentication, exposing sensitive user data and administrative functions.',
        type: 'exposure',
        severity: 'high',
        cvss: 8.2,
        ...
        remediationAdvice:
          'Implement proper authentication and authorization for all API endpoints. Use OAuth 2.0 or JWT tokens. Implement role-based access control (RBAC) and validate permissions on every request.',
      ...
      },
      {
        ...
        description:
          'Critical security headers are missing, increasing vulnerability to XSS, clickjacking, and other client-side attacks.',
        type: 'misconfig',
        severity: 'medium',
        cvss: 5.3,
        ...
        remediationAdvice:
          'Implement all recommended security headers including CSP, X-Frame-Options (DENY), X-Content-Type-Options (nosniff), and HSTS with max-age of at least 31536000 seconds.',
        toolSource: 'Nmap',
        isZeroDay: false,
      },
      {
        ...
        description:
          'The application uses outdated versions of JavaScript libraries with known security vulnerabilities.',
        type: 'cve',
        severity: 'medium',
        cvss: 6.1,
        ...
        remediationAdvice:
          'Update all JavaScript libraries to their latest stable versions. Implement automated dependency scanning in your CI/CD pipeline using tools like npm audit or Snyk.',
  ...
  const scenarios = [
    {
      name: 'Low Risk',
      vulns: [
        { severity: 'low' as SeverityLevel, cvss: 3.1 },
        { severity: 'low' as SeverityLevel, cvss: 2.5 },
        { severity: 'info' as SeverityLevel, cvss: 0.0 },
      ],
    },
    {
      name: 'Medium Risk',
      vulns: [
        { severity: 'medium' as SeverityLevel, cvss: 5.3 },
        { severity: 'medium' as SeverityLevel, cvss: 6.1 },
        { severity: 'low' as SeverityLevel, cvss: 3.7 },
      ],
    },
    {
      name: 'High Risk',
      vulns: [
        { severity: 'high' as SeverityLevel, cvss: 7.5 },
        { severity: 'high' as SeverityLevel, cvss: 8.2 },
        { severity: 'medium' as SeverityLevel, cvss: 5.3 },
      ],
    },
    {
      name: 'Critical Risk',
      vulns: [
        { severity: 'critical' as SeverityLevel, cvss: 9.8 },
        { severity: 'critical' as SeverityLevel, cvss: 9.1 },
        { severity: 'high' as SeverityLevel, cvss: 8.5 },
        { severity: 'high' as SeverityLevel, cvss: 7.8 },
      ],
    },
  ];

  scenarios.forEach((scenario) => {
    const mockVulns: Vulnerability[] = scenario.vulns.map((v, i) => ({
      id: `V${i}`,
...
function example3_prioritization() {
  ...
  const unsortedVulns: Vulnerability[] = [
    {
      id: 'V1',
